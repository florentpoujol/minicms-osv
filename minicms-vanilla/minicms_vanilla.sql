...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 13 Avril 2017 à 21:29
...
INSERT INTO `pages` (`id`, `url_name`, `title`, `content`, `parent_page_id`, `menu_priority`, `user_id`, `creation_date`, `editable_by_all`, `published`) VALUES
...
(5, 'parent-1', 'parent 1', 'voici la liste de nos <strong>produits</strong>.\r\n<br>\r\n[img media-pnfgg 200]\r\n<br>\r\n[img media-jpg blabla]\r\n<br>\r\n[img media-jpeg bli bli]\r\n<br>\r\n[img media-jpg]\r\n<br>\r\n[img media-jpg title="blabla" alt="blibli" height="100px" width="300px"]', NULL, 0, 6, '2016-12-05', 1, 1),
(6, 'carousel', 'Carousel', 'sub 2 <br>\r\n[carousel media-jpg media-jpeg media-png]', 5, 2, 6, '2016-12-05', 1, 1),
(7, 'parent-2', 'parent 2', 'parent 2', NULL, 1, 2, '2016-12-10', 0, 1),
(8, 'sub-3', 'sub 3', 'test', 7, 3, 2, '2016-12-10', 0, 1),
(9, 'sub-4', 'Sub 4', 'sub 4', 7, 0, 2, '2016-12-10', 0, 0),
(10, 'parent-darft', 'parent darft', 'parent darft', NULL, 2, 2, '2016-12-10', 0, 0),
(11, 'sub-6', 'sub 6', 'sub 6', 10, 0, 2, '2016-12-10', 1, 1),
(12, 'parent-4', 'parent 4', 'parent 4', NULL, 4, 6, '2016-12-10', 1, 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_token`, `password_hash`, `role`, `creation_date`) VALUES
(2, 'Admin', 'florentpoujol@fastmail.com', '', '$2y$10$hRNGwXDcYff1mc4rnVww.eFjEpTedz28XHTR6FceokIyi9jEoOvbe', 'admin', '2016-11-27'),
(6, 'Writer', 'florentpoujol@fastmail.com', '', '$2y$10$1ROHZaitjexiZYB5A67UyeIiD4sMw9U1HmKcX5GrY6uxQYluep0fG', 'writer', '2016-11-30');
